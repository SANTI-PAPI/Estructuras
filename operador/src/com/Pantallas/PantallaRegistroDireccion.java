...
public class PantallaRegistroDireccion extends JFrame {
    ...
    public PantallaRegistroDireccion(String nombre, ListaArticulos listaPedido, String telefono) throws FileNotFoundException, IOException, ParseException {
        this.nombre = nombre;
    ...
    public PantallaRegistroDireccion(String nombre, ListaArticulos listaPedido, Cliente cliente) throws FileNotFoundException, IOException, ParseException {
        this.nombre = nombre;
