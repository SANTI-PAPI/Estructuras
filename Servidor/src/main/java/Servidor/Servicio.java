...
public class Servicio extends UnicastRemoteObject implements DatosJSON {
   ...
   * linkedArticulos.add(parseArticuloObject((JSONObject) ar)));
   * 
   ...
   * linkedClientes.add(ParseClienteObject((JSONObject) cl)));
   ...
   * TipoDireccion tipoDir = TipoDireccion.valueOf((String)
   * objetoCliente.get("tipoDireccion"));
   ...
   * 
   * return new Cliente(telefono, nombre, apellido, tipoDir, dir1, dir2, dirAd,
   ...
   * Articulo nuevoArticulo = listaArticulos.contains(Integer.parseInt((String)
   * objetoArticulo.get("id")));
   * return nuevoArticulo;
   * }
   * 
   ...
   * detallesCliente.put("tipoDireccion",
   * clienteActual.getTipoDireccion().toString());
   * detallesCliente.put("direccion1", clienteActual.getDireccion1());
   * detallesCliente.put("direccion2", clienteActual.getDireccion2());
   * detallesCliente.put("direccionAdicional",
   * clienteActual.getDireccionAdicional());
