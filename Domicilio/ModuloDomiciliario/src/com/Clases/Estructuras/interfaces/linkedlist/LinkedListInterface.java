...
public interface LinkedListInterface<T> {
   ...
   * 
   * @return a new instance of the list. If the list is empty, then a new empty
   *         list.
   */
   ...
   * 
   * @param object
   * @return the node of the specified object or a null node if the list does not
   *         contain the object.
   */
   ...
   * 
   * @return an object from the end of the list or a null object if the list is
   *         empty.
   */
  public T getFromEnd();
   ...
   * 
   * @return the last n objects of the list, or an array empty if the list is
   *         empty.
   */
   ...
   * 
   * @return the object from the beginning of the list or a null object if the
   *         list is empty.
   */
  public T pop();
  ...
  /***
   * Removes all nodes from the list that are related to the objects in the
   * specified array.
   * 
   * @param objects
  ...
  /***
   * Removes all nodes from the list that are not related to the objects in the
   * specified array.
   * 
   * @param objects
   * @return 'true' if all nodes was removed successfully, otherwise 'false'.
   ...
   *         If the 'from' node is after the 'to' node or the list is empty,
   *         return a empty list.
   */
   ...
   * 
   * @return an array with the objects of the list or an empty array if the list
   *         is empty.
   */
  public T[] toArray();
   ...
   * 
   * @return a string representation of the list or an empty string if the list is
   *         empty.
   */
